...
In [Singular Value Decomposition](https://github.com/dimitarpg13/probabilistic_model_examples/blob/main/docs/SingularValueDecomposition.md) we choose $v_1,\dots,v_n$ to be perpendicular. Then, let $\lambda = \frac{1}{{\lVert v_i \rVert}^2}$. 
